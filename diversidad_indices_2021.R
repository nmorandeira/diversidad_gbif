...
# Tenemos que definir qué períodos nos interesa comparar. Por ejemplo: 
  # a) comparar entre distintas estaciones del año, en Ceibas.
  # b) comparar entre distintas zonas dentro del área de estudio, que podrían a su vez asociarse a distintos hábitats o a distintos usos del suelo.
